...
print(minhaIdade, type(of: minhaIdade))
...
var twoIncrement = makeTwoIncrement()
print(twoIncrement(40))
...
func isOdd(_ number: Int) -> Int {
    return number % 2 != 0 ? 0 : 1
}
print(numbers.map({number in isOdd(number)}))
