...
class NewShape {
    ...
    // method area
    func simpleDescription() -> String {
        return "This shape has \(numberOfSides) sides."
    }
}
...
class NewNameShape {
    ...
    func simpleDescription() -> String {
        return "This NewNamedShape, named as \(self.name) has \(numberOfSides) sides!"
    }
}

var newNameShape = NewNameShape(name: "'The Answer to the Life, Universe and Evertything")
print(newNameShape.simpleDescription())
...
var triangle: EquilateralTriangle = EquilateralTriangle(sideLength: 3.1, name: "The Triangle")
...
class Circle: NamedShape {
    ...
    init(name: String, radius: Double) {
        // Why property variables must be initialized first, instead of super.init ?
        self.radius = radius
        super.init(name: name)
    }
    
    func calculatingArea() -> Double{
        return self.pi * (self.radius * self.radius)
    }
    
    override func simpleDescription() -> String {
        return "The Circle named as \(self.name), has a radius of \(self.radius) a.u."
    }
}

var circle: Circle = Circle(name: "My first inherited class", radius: 4.0)

print()
print("The Circle '\(circle.name)' has", circle.calculatingArea(), "of area.")
...
let sideLength: Double = optionalSquare?.sideLength ?? 0.0
